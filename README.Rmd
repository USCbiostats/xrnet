...
As an example of using `bigmemory` with `xrnet`, we have a provided a ASCII file that contains the data for `x`. The `bigmemory` function `read.big.matrix()` can be used to create a `big.matrix` version of this file.
