---
title: xrnet:\ R Package for Hierarchical Regularized Regression
...
[![Build Status](https://travis-ci.org/USCbiostats/hierr.svg?branch=development)](https://travis-ci.org/USCbiostats/hierr)
...
As an example of how you might use the xrnet package, we have provided a small set of simulated external data variables (ext), predictors (x), and a continuous outcome variable (y). First, load the example data:
