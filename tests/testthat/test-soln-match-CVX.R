...
test_that("x NOT standardized, ext standardized, no 2nd level intercept",{
    ...
    expect_equal(betas_cvx6,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(TRUE, FALSE), standardize = c(FALSE, TRUE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
...
test_that("x standardized, ext NOT standardized, no 2nd level intercept",{
    ...
    expect_equal(betas_cvx7,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(TRUE, FALSE), standardize = c(TRUE, FALSE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
...
test_that("x NOT standardized, ext NOT standardized, no 2nd level intercept",{
    ...
    expect_equal(alphas_cvx8,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(TRUE, FALSE), standardize = c(FALSE, FALSE), control = list(tolerance = 1e-20))$coef[51:55, 1],
                 tolerance = 1e-5)

    expect_equal(betas_cvx8,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(TRUE, FALSE), standardize = c(FALSE, FALSE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
...
test_that("x NOT standardized, ext standardized, no 1st level intercept",{
    ...
    expect_equal(betas_cvx10,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(FALSE, TRUE), standardize = c(FALSE, TRUE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
...
test_that("x standardized, ext NOT standardized, no 1st level intercept",{
    ...
    expect_equal(betas_cvx11,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(FALSE, TRUE), standardize = c(TRUE, FALSE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
...
test_that("x NOT standardized, ext NOT standardized, no 1st level intercept",{
    ...
    expect_equal(betas_cvx12,
                 hierr(x = x, y = y, ext = z, penalty = myPenalty, intercept = c(FALSE, TRUE), standardize = c(FALSE, FALSE), control = list(tolerance = 1e-20))$coef[1:50, 1],
                 tolerance = 1e-5)
})
