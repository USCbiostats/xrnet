...
test_that("x standardized, intercept",{
    ...
    load(file = "Test-Data/betas_glmnet1.Rdata")
    load(file = "Test-Data/b0_glmnet1.Rdata")
    ...
    expect_equal(b0_glmnet1,
                 hierr(x = x,
                       y = y,
                       family = "gaussian",
                       intercept = c(T, F),
                       penalty = myPenalty,
                       control = myControl)$beta0[10, 1],
                 tolerance = 1e-5)
})

test_that("x NOT standardized, intercept",{

    load(file = "Test-Data/betas_glmnet2.Rdata")
    load(file = "Test-Data/b0_glmnet2.Rdata")
...
test_that("x standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet3.Rdata")
    load(file = "Test-Data/b0_glmnet3.Rdata")
...
test_that("x NOT standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet4.Rdata")
    load(file = "Test-Data/b0_glmnet4.Rdata")
    ...
    expect_equal(betas_glmnet4,
                 hierr(x = x,
                       y = y,
                       family = "gaussian",
                       intercept = c(F, F),
                       standardize = c(F, T),
                       penalty = myPenalty, control = myControl)$betas[, 10, 1],
                 tolerance = 1e-5)

    expect_equal(b0_glmnet4,
                 hierr(x = x,
                       y = y,
                       family = "gaussian",
                       intercept = c(F, F),
...
test_that("x standardized, intercept",{
    ...
    load(file = "Test-Data/betas_glmnet5.Rdata")
    load(file = "Test-Data/b0_glmnet5.Rdata")
...
test_that("x NOT standardized, intercept",{
    ...
    load(file = "Test-Data/betas_glmnet6.Rdata")
    load(file = "Test-Data/b0_glmnet6.Rdata")
...
test_that("x standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet7.Rdata")
    load(file = "Test-Data/b0_glmnet7.Rdata")
...
test_that("x NOT standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet8.Rdata")
    load(file = "Test-Data/b0_glmnet8.Rdata")
...
test_that("x standardized, intercept",{
    ...
    load(file = "Test-Data/betas_glmnet9.Rdata")
    load(file = "Test-Data/b0_glmnet9.Rdata")
...
test_that("x NOT standardized, intercept",{
    ...
    load(file = "Test-Data/betas_glmnet10.Rdata")
    load(file = "Test-Data/b0_glmnet10.Rdata")
...
test_that("x standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet11.Rdata")
    load(file = "Test-Data/b0_glmnet11.Rdata")
...
test_that("x NOT standardized, NO intercept",{
    ...
    load(file = "Test-Data/betas_glmnet12.Rdata")
    load(file = "Test-Data/b0_glmnet12.Rdata")
