...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int& >::type ne(neSEXP);
    Rcpp::traits::input_parameter< const int& >::type nx(nxSEXP);
    rcpp_result_gen = Rcpp::wrap(fitModelRcpp(x, is_sparse_x, y, ext, is_sparse_ext, fixed, weights_user, intr, stnd, penalty_type, cmult, quantiles, num_penalty, penalty_ratio, penalty_user, penalty_user_ext, lower_cl, upper_cl, family, thresh, maxit, ne, nx));
    return rcpp_result_gen;
END_RCPP
}
